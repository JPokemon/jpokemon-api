 ...
 * atomic unit of interaction with a Npc, or other overworld entity. This may
 * include, but is not limited to, trading Pokémon, buying Pokémon, buying
 * items, listening to speech, triggering battles, or making quest progress.
 * 
 * @author zach
 * 
 * @since 0.1
...
public class ActionSet {
	/** Indicates the manager used to register ActionSets. May be null. */
